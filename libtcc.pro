...
TCC_RUNTIME_TARGET_DIR_DEFAULT = $${OUT_PWD}
TCC_SHARED_TARGET_DIR_DEFAULT = $${OUT_PWD}
...
isEmpty(TCC_RUNTIME_TARGET_DIR) {
    TCC_RUNTIME_TARGET_DIR = $${TCC_RUNTIME_TARGET_DIR_DEFAULT}
}
isEmpty(TCC_SHARED_TARGET_DIR) {
    TCC_SHARED_TARGET_DIR = $${TCC_SHARED_TARGET_DIR_DEFAULT}
}
...
isEmpty(TCC_TARGET_ARCHITECTURE) {
    ...
    } else : isEqual(QT_ARCH, i386) {
        TCC_TARGET_ARCHITECTURE = I386
    } else : isEqual(QT_ARCH, arm) {
        TCC_TARGET_ARCHITECTURE = ARM
    }
