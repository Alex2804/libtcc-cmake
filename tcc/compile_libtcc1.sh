...
elif [ $TCC_ARCHITECTURE = i386 ]; then
  ./$TCC -c lib_libtcc1/libtcc1.c
  ./$TCC -c lib_libtcc1/alloca86.S
  ./$TCC -c lib_libtcc1/alloca86-bt.S
  ./$TCC -c lib_libtcc1/bcheck.c -Iinclude
  ./$TCC -ar rcs lib/libtcc1-32.a libtcc1.o alloca86.o alloca86-bt.o bcheck.o
elif [ $TCC_ARCHITECTURE = arm ]; then
  ./$TCC -c lib_libtcc1/libtcc1.c
  ./$TCC -c lib_libtcc1/armeabi.c
  ./$TCC -c lib_libtcc1/alloca-arm.S
  ./$TCC -c lib_libtcc1/armflush.c
  ./$TCC -ar rcs lib/libtcc1-arm.a libtcc1.o armeabi.o alloca-arm.o armflush.o
elif [ $TCC_ARCHITECTURE = arm64 ]; then
